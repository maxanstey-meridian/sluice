...
{
    public readonly Query<CustomerId, CustomerScore> CustomerScore =
        new Query<CustomerId, CustomerScore>("customer.score")
    ...
    public readonly Query<CustomerId, Customer> CustomerScoreDirect =
        new Query<CustomerId, Customer>("customer.score.direct")
            .Key(id => new { customerId = id.Value })
            .Compute(
                async (id, read) =>
                {
